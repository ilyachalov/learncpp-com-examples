...
int main()
{
    ...
    int b = 5;   // начальное значение после знака «равно» (копирующая инициализация)
    ...
    int d{7};    // начальное значение в фигурных скобках (прямая списочная инициализация)
    int e = {8}; // начальное значение в фигурных скобках после знака «равно»
