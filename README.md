...
1. Система «Windows 10», компилятор MSVC (cl.exe) из командной строки, программы-оболочки «cmd.exe» и «PowerShell» версии 7 и выше.
2. Система «Ubuntu» (через «WSL 2»), компилятор «g++» (GCC) из командной строки, программа-оболочка «bash».
