...
Учебник содержит 29 номерных глав 0-28 (некоторые из них находятся в процессе написания и еще не опубликованы; _11 сентября учебник был сильно реорганизован_), одну главу с номером-буквой O, а также четыре приложения A, B, C и D. В папке «[chapters](chapters/)» пока что содержатся только тексты примеров и упражнений глав 0-4, разбитых на подпапки по главам. Со второй главы еще введено разбиение глав на подпапки по урокам (подглавам). Для некоторых уроков (подглав) подпапок нет, так как в этих уроках нет ни примеров, ни упражнений, а только излагается теория.

🚧 *...автор учебника пока не опубликовал главу 5 (она будет выделена из главы 4)...*

🚧 *...примеры и упражнения из главы 6 есть пока только для подглав 6.1-6.3...*
